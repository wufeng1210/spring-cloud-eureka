...
public class Calculator {
    ...
    private String calculate(String firstValue, String secondValue, char currentOp) {
        ...
        switch (currentOp) {
            case '+':
                result = String.valueOf(Arith.add(first, second));
                break;
            case '-':
                result = String.valueOf(Arith.sub(first, second));
                break;
            case '*':
                result = String.valueOf(Arith.mul(first, second));
                break;
            case '/':
                result = String.valueOf(Arith.div(first, second));
                break;
        }
        return result;
    }
